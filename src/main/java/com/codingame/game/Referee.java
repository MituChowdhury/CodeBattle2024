...
//				board.cacheBuild(gameManager.getActivePlayers().get(0), 8, 7, "SPRINGTRAP_U");

//				board.cacheBuild(gameManager.getActivePlayers().get(0), 6, 8, "SPRINGTRAP_U");
//				board.cacheBuild(gameManager.getActivePlayers().get(0), 7, 8, "SPRINGTRAP_U");
//				board.cacheBuild(gameManager.getActivePlayers().get(0), 8, 8, "SPRINGTRAP_U");
...
//				board.cacheBuild(gameManager.getActivePlayers().get(0), 8, 9, "SPRINGTRAP_U");
